"""Test for Immediate Food Delivery II exercise."""
import sys
import os
import json
...
def test_solution():
    """Test the immediate food delivery solution."""
    ...
    print(f"Correct! Immediate first order percentage: {actual[0]['immediate_percentage']}%")
    db.close()
    return True
