"""Test for Friend Requests Acceptance Rate exercise."""
import sys
import os
import json
...
def test_solution():
    """Test the friend requests acceptance rate solution."""
    ...
    print(f"Correct! Friend request acceptance rate: {actual[0]['accept_rate']}")
    db.close()
    return True
