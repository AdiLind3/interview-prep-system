"""Test for Average Selling Price exercise."""
import sys
import os
import json
...
def test_solution():
    """Test the average selling price solution."""
    ...
    print(f"Correct! Calculated average selling prices for {len(actual)} products.")
    db.close()
    return True
